...
def graph_sales_today_api(request):
    """
    API endpoint to retrieve the most recent enrollment activities.

    Typically used for real-time dashboard notifications or daily sales summaries.

    Args:
        request (HttpRequest): Contains 'start_date' and 'end_date' (YYYY-MM-DD).

    Returns:
        JsonResponse: List of recent enrollment records.
    """
    try:
